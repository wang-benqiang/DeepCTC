...
src_path = "cged_test.txt" # 不带sid的source
tgt_path = "cged_pred.txt" # 不带sid的target
#tgt_path = "cged_pred.txt"
f=open('../ensemble_gector/logs/ensemble/4583.txt','w',encoding='utf-8')
