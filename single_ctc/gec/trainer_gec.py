...
import logger
from deeplearning.dataset.gec_dataset import DatasetGec
from deeplearning.loss.focal_loss import FocalCELoss
from deeplearning.modeling.modeling_gec import ModelingGEC
                    ...
                    if (step % self._eval_steps == 0 or epoch_end_flag) and self.ddp_local_rank in (-1, 0):
                        ...
                        if eval_epoch_f1 >= 0:
                            ...
                            if early_stop_time >= self.early_stop_times:
                                ...
                                return 1
            if self.with_train_epoch_metric:
                (epoch_d_precision, epoch_d_recall, d_f1), (epoch_precision, epoch_recall, epoch_f1) = f1_csc(
                    epoch_gold_labels,
                    epoch_preds)
