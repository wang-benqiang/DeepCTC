...
class TrainerGEC:
    def __init__(self,
        ...
        self._keep_c_tag_id = self.tokenizer.vocab['$KEEP']
       
    
    def load_label_dict(self):
        dtag_fp = os.path.join(self.ctc_label_vocab_dir, 'ctc_detect_4tags.txt')
    ...
    def train_step(self, batch_ds, return_for_epoch_metric=True):
        ...
        d_logits, c_logits, batch_loss = self.model(
