...
from src.deeplearning.dataset.ctc_dataset_bart import DatasetCtcBart
from src.deeplearning.modeling.modeling_ctc_bart import ModelingCtcBart
...
class TrainerCtcBart:
    ...
    def load_model(self) -> ModelingCtcBart:
        # Realise
        model = ModelingCtcBart.from_pretrained(
            self.pretrained_model_dir)
    ...
    def train_step(self, batch_ds, return_for_epoch_metric=True):
        ...
        outputs = self.model(
            ...
            labels=batch_ds['c_tags'],
        )
        batch_loss, c_logits = outputs[0], outputs[1]
    ...
    def evaluate(self, data_type='dev'):
        ...
        return epoch_c_loss, neg_sent_precision, neg_sent_recall, neg_sent_f1
