...
from src.deeplearning.dataset.ctc_dataset import DatasetCTC
...
class TrainerCTC:
    ...
    def load_model(self) -> ModelingCTC:
        ...
        model = ModelingCTC.from_pretrained(
            self.pretrained_model_dir) if self.model_type =='bert' else  \
            ModelingCtcElectra.from_pretrained(self.pretrained_model_dir)
