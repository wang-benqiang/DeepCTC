...
class DatasetCscSeq2label(Dataset):
    ""
    ...
    def __init__(self,
        ...
        """
        super(DatasetCscSeq2label, self).__init__()
    ...
    def text_with_chr_confusion(self, correct_text):
        ...
        candidate_idx = [idx for idx, char in enumerate(correct_text) if include_cn(char)]
...
if __name__ == '__main__':
    ...
    d = DatasetCscSeq2label(tokenizer,
                   max_seq_len=128,
                   ctc_label_vocab_dir='src/deeplearning/ctc_vocab',
