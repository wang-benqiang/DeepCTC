...
from utils.gector_helpers import write_lines, read_parallel_lines, encode_verb_form, \
...
def align_sequences(source_sent, target_sent):
    ...
    source_tokens = source_sent
    target_tokens = target_sent
...
# def main():
#     convert_data_from_raw_files(source, target, args.output_file, args.chunk_size, args.max_len)


def gen_src_trg_iteration(src_text, trg_text):
...
if __name__ == '__main__':
    ...
    s ='千克数为30.5千克,纳米数为20，比重:20千克，12英里'
    s = ['千克', '数为', '30.5', '千克', ',', '纳米', '数为', '20', '，', '比重', ':', '20', '千克', '，', '12', '英里']
    t = '质量为30.5千克,长度为20纳米，密度:20千克，19.3121公里'
    t = ['质量', '为', '30.5', '千克', ',', '长度', '为', '20', '纳米', '，', '比重', ':', '20', '千克', '，', '19.3121', '公里']
    r = align_sequences(s, t)
    print(list(zip(s, r[1:])))
    print(r)
