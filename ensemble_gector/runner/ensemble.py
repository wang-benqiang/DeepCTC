...
def parse_args():
    ...
    parser.add_argument('--base_fp', default='logs/ensemble/4583.txt')
    parser.add_argument('--other_fp', default='logs/ensemble/cged.pred.txt')
    parser.add_argument('--out_fp', default='logs/ensemble/cged.pred_final.txt')
...
if __name__ == '__main__':
    ...
    #     'logs/gector/cged.pred_model_1.txt',
    #     'logs/gector/cged.pred_model_2.txt',
    #     'logs/gector/cged.pred_model_3.txt',
    #     'logs/gector/cged.pred_model_4.txt'

    # ]
    # # out_list = []
    # r = ensembel_results(fp_list, out_fp='logs/ensemble/cged.pred1.txt')
    # print(r)
    args = parse_args()
    ensemble2(
        base_fp=args.base_fp,
        other_fp=args.other_fp,
        out_fp=args.out_fp
    )
