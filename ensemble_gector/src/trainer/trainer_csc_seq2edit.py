...
from src.dataset.dataset_csc_seq2edit import DatasetCscSeq2Edit
...
class TrainerCscSeq2Edit:
    ...
    def load_suite(self):
        "model"
        model = ModelingCscSeq2Edit.from_pretrained(
            self.in_model_dir)
    ...
    def evaluate(self, dataset_type='dev'):
        ...
        for batch_ds in dataloader:
            ...
            batch_c_logits, batch_d_logits, batch_loss, batch_src, batch_gold = self.accelerator.gather(
                (batch_c_logits, batch_d_logits, batch_loss, batch_ds['input_ids'], batch_ds['correct_labels']))
