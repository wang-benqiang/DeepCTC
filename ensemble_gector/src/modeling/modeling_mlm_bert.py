...
class ModelingBertMlm(BertPreTrainedModel):
    "单纯使用Roberta预训练模型"
    ...
    def __init__(
        ...
        super(ModelingBertMlm, self).__init__(config)
...
if __name__ == '__main__':
    in_model_dir = 'pretrained_model/chinese-macbert-large'
    model = ModelingBertMlm.from_pretrained(in_model_dir)
    print('___')