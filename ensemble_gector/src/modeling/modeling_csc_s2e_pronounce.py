...
class ModelingCscS2ePronounce(BertPreTrainedModel):
...
if __name__ == '__main__':
    ...
    model = ModelingCscS2ePronounce.from_pretrained(pretrained_dir)
    inputs = ModelingCscS2ePronounce.build_dummpy_inputs()
    r = model(**inputs)
    print(1)
